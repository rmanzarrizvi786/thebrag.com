    ...
    if ( $query->have_posts()) :
        while ($query->have_posts()) :
            ...
            $articles_arr[] = [
                ...
                'title' => get_the_title(),
                'category' => $categories[0]->cat_name,
                'brand_logo' => 'https://images-r2.thebrag.com/common/brands/thebrag.png',
...
function tbm_create_spotlight_articles( $article_url ) {
    ...
    if( $filename == 'comingsoon' ) {
        $height = '1.75rem';
    }

    if( $filename == 'deadline' ) {
        $height = '0.80rem';
    }

    if( $filename == 'indiewire' ) {
        $height = '1rem';
    }
    ...
    $articles_arr = [
        ...
        'category' => '',
        'brand_logo_light' => "https://images-r2.thebrag.com/common/brands/202309/" . $filename . "-light.png",
        'brand_logo_dark' => "https://images-r2.thebrag.com/common/brands/202309/" . $filename . "-dark.png",
