...
?>
    <form method="post" class="form">
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            <div class="col-12"><h3>Shout the writer a beer - settings</h3></div>
            <div class="col-12">
              ...
              <div class="form-group">
                ...
                <input
                  name="tbm_shout_beer_about_url" id="tbm_shout_beer_about_url" type="text"
                  value="<?php echo stripslashes( get_option( 'tbm_shout_beer_about_url' )  ); ?>"
...
//            echo $queryString; exit;
  ...
  ?>
    ...
    <script>grecaptcha.ready(function() {
      grecaptcha.execute("<?php echo $this->recaptchaSiteKey; ?>", {action: "shout_beer"}).then(function (token) {
      ...
      <div class="btn-shout-writer-beer" data-toggle="form-shout-writer-beer">
        <div style="display: flex; align-items: center;">
          <a href="https://younghenrys.com/" target="_blank" class="l-logo-beer">
            <span class="logo-beer" style="display: none;"><img src="<?php echo plugins_url( 'images/yh-logo-blk.png', __FILE__ ); ?>"></span>
          </a>
