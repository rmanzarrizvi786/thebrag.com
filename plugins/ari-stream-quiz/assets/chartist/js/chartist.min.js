...
/* Plugins */
;eval(function(p,a,c,k,e,r){e=function(c){return(c<62?'':e(parseInt(c/62)))+((c=c%62)<36?c.toString(36):String.fromCharCode(c+29))};if('0'.replace(0,e)==0){while(c--)r[e(c)]=k[c];k=[function(e){return r[e]||e}];e=function(){return'\\w'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}(';(8(A,C,3){4 M={},I={};3.d=3.d||{};3.d.ctPrepareBarLabel=8(9){9=3.H({},I,9);a 8(6){6.G(\'1\',8(1){4 7=1[\'1\'][\'7\'][0],u=6.9.lblBaseValue||0;D(4 i=0;i<7.w;i++){4 o=7[i],B=u>0?((o/u)*100).toFixed(2):0;7[i]={c:B+\'%\\n\'+o,value:7[i]}};1.1={b:1.b,7:[7]}})}};3.d.ctBarLabel=8(9){9=3.H({},M,9);a 8(6){6.G(\'draw\',8(1){e(!(6 instanceof 3.Bar))a;e(1.type!=\'bar\')a;4 c=1.c||\'\';e(!c)a;4 b=c.split(\'\\n\'),p=b.w;4 q=15,E=1.chartRect.k(),z=1.r.k(),s=(0.5+p)*q,t=1.x1,h=v,g=v;e(E-z>s){h=(1.F-(1.r.k())-s);g=\'6-m-f-outline\'}else{h=(1.F-(1.r.k()));g=\'6-m-f-inline\'}4 l=J 3.K(\'L\');D(4 i=0;i<p;i++){4 j=J 3.K(\'tspan\');j.L(b[i]);j.N({\'O\':\'6-m-f-line\'+i,x:t,dy:q});l.P(j)};l.N({\'O\':\'6-m-f \'+g,x:t,y:h});1.group.P(l)})}}})(A,C,3);',[],52,'|data||Chartist|var||chart|series|function|options|return|labels|meta|plugins|if|label|posClass|labelYPos||tspanNode|height|labelNode|item||val|labelCount|blockHeight|element|labelContainerHeight|labelXPos|baseValue|null|length|||barHeight|window|percent|document|for|chartHeight|y1|on|extend|barPrepareLabelDefaultOptions|new|Svg|text|barLabelDefaultOptions|attr|class|append'.split('|'),0,{}));