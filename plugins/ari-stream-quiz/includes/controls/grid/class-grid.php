<?php
namespace Ari_Stream_Quiz\Controls\Grid;
...
class Grid extends Grid_Base {
    function __construct( $id, $options ) {
        ...
        $main_options = array_replace(
            array(
                'no_data_message' => __( 'No results found', 'ari-stream-quiz' ),

                'class' => 'striped z-depth-1',
        ...
        wp_enqueue_script( 'ari-grid', ARISTREAMQUIZ_ASSETS_URL . 'common/grid.js', array( 'jquery' ), ARISTREAMQUIZ_VERSION );
    }
}
