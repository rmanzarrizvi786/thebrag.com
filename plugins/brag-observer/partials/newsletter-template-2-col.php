                      ...
                      <tbody>
                        ...
                        <tr>
                          <td class="mcnTextContent" valign="top" style="padding: 9px 0;color: #000000;font-family: Helvetica;font-size: 14px;font-style: normal;font-weight: normal;line-height: 150%;text-align: center;">
                            <h2>
                              <font color="#ffffff">
                                <a href="<?php echo $newsletter->details->post_links[$article_number]; ?>?utm_source=<?php echo urlencode($newsletter->details->from_name); ?>&utm_medium=email&utm_campaign=<?php echo urlencode($newsletter->details->title); ?>" target="_blank" style="color: #000000; text-decoration: none;">
                                  <?php echo strtoupper($newsletter->details->post_titles[$article_number]); ?>
                                </a>
                              </font>
                            </h2>
                            <div style="margin-top: 9px;text-align: left; font-size:16px; color:#000000; font-family:arial,helvetica neue,helvetica,sans-serif">
                              <?php echo $newsletter->details->post_excerpts[$article_number]; ?>
                            </div>
                          </td>
                        </tr>
