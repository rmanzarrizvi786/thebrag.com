											...
											<tr style="padding:0;text-align:center;vertical-align:top">
												<td style="border: 3px solid #3298d3; width: 580px;">
													<a href="<?php echo $top_i_tweet_link; ?>" target="_blank" style="color: #231f20;text-decoration: none;">
														<img align="none" class="" width="580" alt="Top Industry Post" src="https://images-rs.thebrag.com/tb/uploads/edm/Top-Industry-Post.jpg" style="outline: none;-ms-interpolation-mode: bicubic;max-width: 100%;border: none; width: auto; max-width: 580px;">
													</a>
													<br>
													<a href="<?php echo $top_i_tweet_link; ?>" target="_blank" style="color: #231f20;text-decoration: none;">
											...
											<tr style="padding:0;text-align:center;vertical-align:top">
												<td style="border: 3px solid #3298d3; width: 580px;">
													<a href="<?php echo $birthday_shoutout_link; ?>" target="_blank" style="color: #231f20;text-decoration: none;">
														<img align="none" class="" width="580" alt="Top Industry Tweet" src="https://images-rs.thebrag.com/tb/uploads/edm/Birthday-Shout-Out.jpg" style="outline: none;-ms-interpolation-mode: bicubic;max-width: 580px;border: none; width: auto;">
													</a>
													<br>
...
<![endif]-->
	...
	function print_ad($value, $ads_after_articles, $newsletter, $container_width = 700)
	{
		...
		$passendo_ads_key = 11; // Default to Asia Pop

		if (in_array($newsletter->list_id, array_keys(passendo_ads()))) {
			$passendo_ads_key = $newsletter->list_id;
		}
											...
											<tbody>
												<tr>
													<td class="mcnImageCardBottomImageContent" align="center" valign="top" style="padding-top:0px; padding-right:0px; padding-bottom:0; padding-left:0px; text-align: center;">
														<?php
														echo $passendo_ads[$passendo_ads_key][$index];
														?>
													</td>
												</tr>
											</tbody>
	...
	function passendo_ads()
	{
		return [
			// Tech
			52 => [
				1 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/48428/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/48428/{{\${email_address}}}/{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/48428/{{\${email_address}}}/{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48428/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48428/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48428/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48428/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/48428/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/48428/{{\${email_address}}}/{{campaign.\${api_id}}}'></a></td></tr></table>",
				2 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/48429/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/48429/{{\${email_address}}}/{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/48429/{{\${email_address}}}/{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48429/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48429/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48429/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48429/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/48429/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/48429/{{\${email_address}}}/{{campaign.\${api_id}}}'></a></td></tr></table>",
				3 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/48430/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/48430/{{\${email_address}}}/{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/48430/{{\${email_address}}}/{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48430/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48430/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48430/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48430/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/48430/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/48430/{{\${email_address}}}/{{campaign.\${api_id}}}'></a></td></tr></table>",
			],

			// Gaming
			19 => [
				1 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/48425/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/48425/{{\${email_address}}}/{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/48425/{{\${email_address}}}/{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48425/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48425/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48425/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48425/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/48425/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/48425/{{\${email_address}}}/{{campaign.\${api_id}}}'></a></td></tr></table>",
				2 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/48426/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/48426/{{\${email_address}}}/{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/48426/{{\${email_address}}}/{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48426/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48426/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48426/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48426/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/48426/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/48426/{{\${email_address}}}/{{campaign.\${api_id}}}'></a></td></tr></table>",
				3 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/48427/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/48427/{{\${email_address}}}/{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/48427/{{\${email_address}}}/{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48427/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48427/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48427/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/48427/{{\${email_address}}}/{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/48427/{{\${email_address}}}/{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/48427/{{\${email_address}}}/{{campaign.\${api_id}}}'></a></td></tr></table>",
			],
			...
			// Hip Hop
			2 => [
				1 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43208/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43208/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43208/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43208/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43208/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43208/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43208/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43208/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43208/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				2 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43209/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43209/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43209/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43209/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43209/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43209/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43209/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43209/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43209/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				3 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43210/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43210/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43210/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43210/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43210/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43210/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43210/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43210/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43210/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
			],

			// Electronic
			9 => [
				1 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43211/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43211/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43211/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43211/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43211/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43211/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43211/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43211/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43211/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				2 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43212/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43212/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43212/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43212/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43212/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43212/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43212/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43212/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43212/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				3 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43213/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43213/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43213/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43213/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43213/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43213/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43213/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43213/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43213/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
			],

			// Blues Roots
			10 => [
				1 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43214/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43214/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43214/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43214/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43214/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43214/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43214/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43214/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43214/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				2 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43215/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43215/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43215/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43215/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43215/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43215/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43215/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43215/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43215/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				3 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43216/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43216/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43216/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43216/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43216/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43216/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43216/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43216/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43216/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
			],

			// Country
			8 => [
				1 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43217/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43217/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43217/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43217/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43217/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43217/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43217/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43217/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43217/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				2 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43218/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43218/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43218/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43218/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43218/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43218/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43218/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43218/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43218/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				3 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43219/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43219/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43219/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43219/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43219/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43219/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43219/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43219/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43219/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
			],

			// Emo
			3 => [
				1 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43220/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43220/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43220/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43220/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43220/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43220/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43220/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43220/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43220/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				2 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43221/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43221/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43221/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43221/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43221/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43221/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43221/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43221/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43221/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				3 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43222/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43222/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43222/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43222/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43222/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43222/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43222/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43222/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43222/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
			],

			// Fashion & Beauty
			58 => [
				1 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43223/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43223/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43223/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43223/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43223/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43223/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43223/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43223/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43223/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				2 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43224/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43224/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43224/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43224/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43224/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43224/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43224/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43224/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43224/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				3 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43225/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43225/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43225/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43225/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43225/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43225/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43225/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43225/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43225/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
			],

			// Metal
			49 => [
				1 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43226/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43226/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43226/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43226/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43226/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43226/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43226/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43226/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43226/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				2 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43227/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43227/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43227/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43227/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43227/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43227/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43227/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43227/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43227/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				3 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43228/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43228/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43228/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43228/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43228/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43228/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43228/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43228/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43228/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
			],

			// EBO
			61 => [
				1 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43605/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43605/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43605/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43605/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43605/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43605/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43605/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43605/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43605/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				2 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43606/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43606/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43606/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43606/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43606/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43606/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43606/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43606/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43606/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
				3 => "<table border='0' cellpadding='0' cellspacing='0'><tr><td style='font-size: 0px;'><a href='http://observer.thebrag.media/click/2/43607/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/view/2/43607/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/t/2/43607/{{\${email_address}}}/{{{campaign.\${api_id}}}/0/0'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43607/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=1'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43607/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=2'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43607/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=3'><img width='1' height='1' style='display:none;border-style:none;' alt='' src='https://observer.thebrag.media/extt/2/43607/{{\${email_address}}}/{{{campaign.\${api_id}}}?pid=4'></td></tr><tr><td style='font-size: 0px;'><a title='Privacy Info' target='_blank' href='http://observer.thebrag.media/ppc/2/43607/{{\${email_address}}}/{{{campaign.\${api_id}}}'><img src='https://observer.thebrag.media/ppv/2/43607/{{\${email_address}}}/{{{campaign.\${api_id}}}'></a></td></tr></table>",
			],
		];
	}
