  ...
  <table class="table table-sm table-light">
    ...
    <tr>
      <td colspan="4">Subject <small>Max 150 characters</small>
        <input type="text" name="subject" value="<?php echo isset($newsletter) && isset($newsletter->details->subject) ? htmlentities( $newsletter->details->subject ) : ''; ?>" maxlength="150" class="form-control"></td>
    </tr>
    <tr>
      <td colspan="4">Preview Text <small>Max 150 characters</small>
        <input type="text" name="preview_text" value="<?php echo isset($newsletter) && isset($newsletter->details->preview_text) ? htmlentities( $newsletter->details->preview_text ) : ''; ?>" maxlength="150" class="form-control"></td>
    </tr>
    <tr>
      <td>Date<br>
      ...
      <td>Reply to <small>Email Address</small><br>
        <input type="text" name="reply_to" value="<?php echo isset($newsletter) && isset($newsletter->details->reply_to) ? $newsletter->details->reply_to : 'observer@thebrag.media'; ?>" class="form-control"></td>

      <td>From Name<br>
        <input type="text" name="from_name" value="<?php echo isset($newsletter) && isset($newsletter->details->from_name) ? $newsletter->details->from_name : trim( str_ireplace( 'Observer', '', $list->title ) ) . ' Observer'; ?>" class="form-control"></td>
    </tr>
    ...
    <tr>
      <td style="border-right: 1px solid #ddd;">
        ...
        <!-- <div class="input-group mb-2">
          ...
          <textarea name="top_i_tweet_blurb" class="form-control"><?php // echo isset($newsletter) && isset($newsletter->details->top_i_tweet_blurb) ? htmlentities( $newsletter->details->top_i_tweet_blurb ) : ''; ?></textarea>
        </div> -->
        <!-- Top Industry Tweet -->
        ...
        ?>
        <!-- <textarea name="intro_content" class="form-control" rows="10"><?php // echo isset($newsletter) && isset($newsletter->details->intro_content) ? htmlentities( $newsletter->details->intro_content ) : ''; ?></textarea> -->
      </td>
