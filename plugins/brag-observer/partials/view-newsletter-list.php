...
?>
  ...
  <tr>
    ...
    <td><?php echo $newsletter->status == 1 ? 'Created on MC' : 'Draft'; ?></td>
    <td class="text-right" style="width: 325px;">
      <a href="<?php echo add_query_arg( [ 'page' => 'brag-observer-manage-newsletter', 'action' => 'preview', 'id' => $newsletter->id, 'list_id' => $newsletter->list_id ] ); ?>" class="btn btn-sm btn-primary" target="_blank" title="Click to preview">Preview</a>

      <a href="<?php echo add_query_arg( [ 'page' => 'brag-observer-manage-newsletter', 'action' => 'edit', 'id' => $newsletter->id ], remove_query_arg( 'list_id' ) ); ?>" class="btn btn-sm btn-info">Edit</a>

      <a href="<?php echo add_query_arg( [ 'page' => 'brag-observer-manage-newsletter', 'action' => 'copy', 'id' => $newsletter->id ], remove_query_arg( 'list_id' ) ); ?>" class="btn btn-sm btn-warning">Copy</a>

      <a href="<?php echo add_query_arg( [ 'page' => 'brag-observer-manage-newsletter', 'action' => 'create-on-mc', 'id' => $newsletter->id ], remove_query_arg( 'list_id' ) ); ?>" class="btn btn-sm btn-success">Push to MailChimp</a>
    </td>
  </tr>
<?php
