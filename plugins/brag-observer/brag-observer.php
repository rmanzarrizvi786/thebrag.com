      ...
      if (isset($data['post_images'])) :
        foreach ($data['post_images'] as $key => $image_url) :
          if ($image_url) :
            ...
            $image_url_edit = str_replace("https://images.thebrag.com/cdn-cgi/image/fit=crop,width=660,height=370/", "", $image_url);
            $image_url = empty($image_url_edit) ? $image_url : $image_url_edit;
