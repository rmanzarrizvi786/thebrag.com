...
class Imports extends BragObserver
{
  ...
  public function __construct()
  {
    ...
    add_action('wp_ajax_tmp_generate_oc_tokens', [$this, 'tmp_generate_oc_tokens']);
  ...
  public function _admin_menu()
  {
    ...
    add_submenu_page(
      $this->plugin_slug,
      '[TMP] Generate OC Tokens',
      '[TMP] Generate OC Tokens',
      'administrator',
      $this->plugin_slug . '-tmp-generate-oc-tokens',
      array($this, 'show_tmp_generate_oc_tokens')
    );
  }

  public function show_tmp_generate_oc_tokens()
  {
    include PLUGINPATH . '/partials/tmp-generate-oc-tokens.php';
  }

  public function tmp_generate_oc_tokens()
  {
    ...
    $subs = $wpdb->get_results($subs_query);
