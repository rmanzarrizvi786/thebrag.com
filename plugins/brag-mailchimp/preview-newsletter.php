                                        ...
                                        <tr>
                                            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                                                ...
                                                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:390px;" width="100%" class="mcnTextContentContainer">
                                                    <tbody>
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-left: 5px; padding-bottom:9px; padding-right:18px;">
                                                                <?php if ( 1 == $newsletter->blod_id ) : ?>
                                                                The latest in music, comedy and more from thebrag.com
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 10px; padding-bottom: 10px; text-align:center; background: #ffffff;">
                                                                <a href="<?php echo esc_url( $brag_sites[$newsletter->blog_id]['link'] ); ?>" title="" class="" target="_blank">
                                                                    <img align="center" alt="<?php echo $brag_sites[$newsletter->blog_id]['title']; ?>" src="<?php echo esc_url( $brag_sites[$newsletter->blog_id ]['logo'] ); ?>" width="152" style="max-width:152px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center" valign="top" style="padding-top:9px; padding-right:9px; padding-left:9px;">
                                                                                <?php print_social_icons( $newsletter ); ?>
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                        ...
                                                        <tr>
                                                            <td class="mcnImageCardBottomImageContent" align="left" valign="top" style="padding-top:0px; padding-right:0px; padding-bottom:0; padding-left:0px;">
                                                                ...
                                                                <a href="<?php echo $newsletter->details->featured_story_link_1; ?>" target="_blank">
                                                                    <img align="center" alt="<?php echo $newsletter->details->featured_story_title_1; ?>" src="<?php echo $newsletter->details->featured_story_image_1; ?>" width="564" style="max-width:625px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                                </a>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="mcnImageCardBottomImageContent" align="left" valign="top" style="padding-top:0px; padding-right:0px; padding-bottom:0; padding-left:0px;">
                                                                ...
                                                                <a href="<?php echo $newsletter->details->featured_story_link_2; ?>" target="_blank">
                                                                    <img align="center" alt="<?php echo $newsletter->details->featured_story_title_2; ?>" src="<?php echo $newsletter->details->featured_story_image_2; ?>" width="564" style="max-width:625px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                                </a>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
...
<?php
endif; // If Featured Article 2 is available
?>
...
<?php
if( isset( $newsletter->details->featured_story_title_3 ) && $newsletter->details->featured_story_title_3 != '' ):
?>
                        <tr>
                            <td style="background-color: #ffffff;" class="templateLowerColumns">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnImageCardBlock">
                                            ...
                                            <td class="mcnImageCardBlockInner" valign="top" style="padding-top:9px; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                <table align="right" border="0" cellpadding="0" cellspacing="0" class="mcnImageCardBottomContent" width="100%" style="background-color: #000000;">
                                                    <tbody>
                                                        <tr>
                                                            <td class="mcnImageCardBottomImageContent" align="left" valign="top" style="padding-top:0px; padding-right:0px; padding-bottom:0; padding-left:0px;">
                                                                <?php if ( isset( $newsletter->details->featured_story_image_3 ) && $newsletter->details->featured_story_image_3 != '' ) : ?>
                                                                <a href="<?php echo $newsletter->details->featured_story_link_3; ?>" target="_blank">
                                                                    <img align="center" alt="<?php echo $newsletter->details->featured_story_title_3; ?>" src="<?php echo $newsletter->details->featured_story_image_3; ?>" width="564" style="max-width:625px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                                </a>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="mcnTextContent" valign="top" style="padding: 9px 18px;color: #F2F2F2;font-family: Helvetica;font-size: 14px;font-style: normal;font-weight: normal;line-height: 150%;text-align: center;" width="546">
                                                                <h1 class="null"><font color="#ffffff"><?php echo $newsletter->details->featured_story_title_3; ?></font></h1>
                                                                <div style="text-align: left;"><span style="font-size:16px"><span style="color:#FFFFFF"><span style="font-family:arial,helvetica neue,helvetica,sans-serif"><?php echo $newsletter->details->featured_story_excerpt_3; ?></span></span></span></div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
...
<?php
endif; // If Featured Article 3 is available
?>
...
?>
	                                                            ...
	                                                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
	                                                                <a href="<?php echo  esc_url( $mime_link ); ?>" title="" class="" target="_blank">
	                                                                    <?php if( $mime_screenshot ) { ?>
		                                                                    <img alt="Click Here to visit MEME " align="center" src="<?php echo esc_url( $mime_screenshot ); ?>" width="400" style="max-width:564px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
		                                                                <?php } else {
                        ...
                        <tr>
                            <td valign="top" class="templateFooter" style="background: #ffffff; text-align: center; padding: 10px 0;">
                                <img alt="<?php echo $brag_sites[$newsletter->blog_id ]['title']; ?>" src="<?php echo esc_url( $brag_sites[$newsletter->blog_id ]['logo'] ); ?>" width="152" style="max-width:100%; padding-bottom: 0; display: inline !important; vertical-align: bottom;">
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <tr>
                                            <td class="mcnCaptionBottomImageContent" align="center" valign="top" style="padding:0 9px 9px 9px;">
                                                ...
                                                <a href="<?php echo $newsletter->details->post_links->{$article_number}; ?>" title="" class="" target="_blank">
                                                    <img alt="<?php echo $newsletter->details->post_titles->{$article_number}; ?>" src="<?php echo  $newsletter->details->post_images->{$article_number}; ?>" width="264" style="max-width:625px;" class="mcnImage">
                                                </a>
                                                <?php else: ?>
                                                    <img alt="<?php echo $newsletter->details->post_titles->{$article_number}; ?>" src="<?php echo  $newsletter->details->post_images->{$article_number}; ?>" width="264" style="max-width:625px;" class="mcnImage">
                                                <?php endif; ?>
...
function print_social_icons( $newsletter ) {
	...
	$blog_id = get_current_blog_id();
        if ( '127.0.0.1' == $_SERVER['REMOTE_ADDR'] ) {
            $bm_social_links = array(
                'facebook' => array(
                    1 => 'https://www.facebook.com/thebragmag',
                    5 => 'https://www.facebook.com/thebragdad/',
                    6 => 'https://www.facebook.com/dontboreus'

                ),
                'twitter' => array(
                    1 => 'https://twitter.com/thebrag',
                    5 => 'https://twitter.com/thebragdad',
                    6 => 'https://twitter.com/dontboreus'
                ),
                'instagram' => array(
                    1 => 'https://instagram.com/thebragmag',
                    5 => 'https://www.instagram.com/thebragdad/',
                    6 => 'https://www.instagram.com/dontboreus/'
                ),
                'link' => array(
                    1 => 'https://thebrag.com',
                    5 => 'https://dad.thebrag.com/',
                    6 => 'https://dontboreus.thebrag.com/'
                )
            );
        } else {
            $bm_social_links = array(
                'facebook' => array(
                    1 => 'https://www.facebook.com/thebragmag',
                    2 => 'https://www.facebook.com/thebragdad/',
                    3 => 'https://www.facebook.com/dontboreus'

                ),
                'twitter' => array(
                    1 => 'https://twitter.com/thebrag',
                    2 => 'https://twitter.com/thebragdad',
                    3 => 'https://twitter.com/dontboreus'
                ),
                'instagram' => array(
                    1 => 'https://instagram.com/thebragmag',
                    2 => 'https://www.instagram.com/thebragdad/',
                    3 => 'https://www.instagram.com/dontboreus/'
                ),
                'link' => array(
                    1 => 'https://thebrag.com',
                    2 => 'https://dad.thebrag.com/',
                    3 => 'https://dontboreus.thebrag.com/'
                )
            );
        }
?>
                                                                                                                                    ...
                                                                                                                                    <tbody>
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                                                                                <a href="<?php echo esc_url( $bm_social_links[ 'facebook' ][$newsletter->blog_id ] ); ?>" target="_blank"><img alt="Facebook" src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-facebook-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                    </tbody>
                                                                                                                                </table>
                                                                                                                            ...
                                                                                                                            <td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">
                                                                                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                                                                                    <tbody>
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                                                                                <a href="<?php echo esc_url( $bm_social_links[ 'twitter' ][$newsletter->blog_id ] ); ?>" target="_blank"><img alt="Twitter" src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-twitter-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                    </tbody>
                                                                                                                                </table>
                                                                                                                            ...
                                                                                                                            <td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">
                                                                                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                                                                                    <tbody>
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                                                                                <a href="<?php echo esc_url( $bm_social_links[ 'facebook' ][$newsletter->blog_id ] ); ?>" target="_blank"><img alt="Instagram" src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-instagram-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                    </tbody>
                                                                                                                                </table>
                                                                                                                            ...
                                                                                                                            <td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">
                                                                                                                                <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                                                                                    <tbody>
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                                                                                <a href="<?php echo esc_url( $bm_social_links[ 'link' ][$newsletter->blog_id ] ); ?>" target="_blank"><img alt="#" src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-link-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                    </tbody>
                                                                                                                                </table>
