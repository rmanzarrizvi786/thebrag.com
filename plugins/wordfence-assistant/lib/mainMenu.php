<div class="wrap wordfence">
	...
	<h3>Disable Wordfence IP Blacklist</h3>
	<p>
		...
		when wanted.
		<br /><br />
		<input class="button-primary" type="button" name="but1" value="Disable Wordfence IP Blacklist" onclick="WFAST.disableBlacklist(); return ;" />
