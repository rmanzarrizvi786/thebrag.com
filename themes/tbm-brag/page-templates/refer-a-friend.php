...
<style>
  ...
  <?php $fragment_width = '25'; ?>.show-neighbors {
    overflow: hidden;
  }
...
<div class="container bg-yellow rounded-top p-2">
  ...
  <div class="row justify-content-center align-items-start">
    ...
    <div id="" class="col-12 col-md-9 p-md-3">
                  ...
                  <div class="col-12">
                    <div class="d-flex">
                      <?php foreach ($rewards as $reward) : ?>
                        <div class="px-1">
                          <img src="<?php echo OBSERVER_CDN_URL; ?>images/refer-a-friend/rewards_0<?php echo $reward->id; ?>.jpg">
                        </div>
                      <?php endforeach; ?>
                    </div>
                  </div>
        ...
        <div class="mt-3">
          <div class="col align-items-center d-block d-md-flex mb-1">
            <div class="dark-pill rounded mr-3">
              ...
              <a href="#share">
                <div class="white-pill rounded ml-2 d-flex justify-content-center align-items-center"><?php echo $referrals_count; ?></div>
              </a>
            </div>
      ...
      if ($lists) :
      ?>
        <div class="container bg-yellow pb-4">
          <div class="">
            ...
            <div class="d-flex flex-wrap">
              ...
              <div class="col-md-8 col-11 mt-3">
                <textarea class="form-control" id="share-link" onclick="this.select();" readonly="" rows="1" style="padding-top: .6rem; padding-bottom: .6rem; resize: none; word-break: break-all; background-color: #fff;"><?php echo $referral_link; ?></textarea>
              </div>
              <div class="col-1 mt-3">
                <button class="btn btn-dark btn-copy" data-clipboard-action="copy" data-clipboard-target="#share-link">
                  <img src="<?php echo ICONS_URL; ?>copy.svg" width="16" height="16">
                </button>
              </div>
            </div>
            ...
            <div class="">
              <div class="col-12">
                ...
                <div class="text-muted m-0">
                  <span>
                    Invite people to subscribe to</span>
                  <span><select name="list" id="list-invite" class="form-control d-inline w-auto">
                      <?php foreach ($lists as $list) : ?>
                  ...
                  <span>by entering in their emails. (We'll automatically add your referral link!)</span>
                </div>
              ...
              <div class="col-12">
                ...
                <div class="row mt-2">
                  <div class="col-12">
                    ...
                    <button name="button" type="submit" class="button btn btn-dark rounded mt-1 mb-4">
                      <img src="<?php echo ICONS_URL; ?>paper-plane.svg" width="16" height="16">
