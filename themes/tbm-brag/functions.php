...
{
    wp_enqueue_script('scripts', CDN_URL . 'scripts.min.js', array('jquery'), '20210608.1', true);
...
function ssm_inject_ads($content)
{
    ...
    ob_end_clean();
    $content = ssm_insert_after_paragraph('<div class="my-2 text-center ad-mrec">' . $content_ad_tag . '</div>', $after_para, $content);
