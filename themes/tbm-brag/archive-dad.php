<?php get_template_part( 'partials/header-dad' ); ?>
    ...
    <div id="section-hero" class="row">
        ...
        <?php
            $cover_story_args = array(
                ...
                'posts_per_page' => 1,
                'post_type' => 'dad',
                'p' => get_option( 'most_viewed_yesterday_dad' ),
            );
            ...
            if ( isset( $cover_story_ID ) && !is_null( $cover_story_ID ) && $cover_story_ID != '' ) :
