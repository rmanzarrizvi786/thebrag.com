...
<div id="page" class="">
      <div id="header-wrap" style="height: auto;">
        <div id="header" class="container-fluid bg-white p-0">
          ...
          <div id="brag_inskin"><script>googletag.cmd.push(function() { googletag.display('brag_inskin'); });</script></div>
