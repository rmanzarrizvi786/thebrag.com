...
<noscript id="deferred-styles">
  ...
  ?>
  <link rel="stylesheet" id="tbm-css" href="<?php echo CDN_URL; ?>/css/style.css?v=20210602.6" type="text/css" media="all" />
  <!-- <link rel="stylesheet" id="tbm-css" href="<?php echo get_template_directory_uri(); ?>/css/style.css?v=20210602.4" type="text/css" media="all" /> -->
  <?php // endif; 
  ?>
</noscript>
