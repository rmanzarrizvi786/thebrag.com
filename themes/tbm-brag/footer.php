...
<!-- <?php echo function_exists('get_field') && get_field('paid_content', $post->ID) ? 'yes' : 'no'; ?> -->
...
<noscript id="deferred-styles">
  ...
  <link rel="stylesheet" id="tbm-css" href="<?php echo CDN_URL; ?>css/style.css?v=20220629" type="text/css" media="all" />
