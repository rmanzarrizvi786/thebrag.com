<?php if ((!is_page_template('page-quiz.php') && !is_singular('post') && !is_singular('issue')) || is_page_template('single-template-quiz-aviso.php')) :
  include_once get_template_directory() . '/partials/menu-footer.php';
endif; ?>
        ...
        <div class="modal-content">
          <div class="modal-body">
            <div class="newsletter-box">
              ...
              <h2 class="text-center py-3 px-5">Get The Brag to your inbox daily</h2>
              <p>Stay on top of the most important music news and interviews each day, delivered free, direct to your inbox.</p>

              <div id="mail" class="newsletter-form">
                <form action="//media.us1.list-manage.com/subscribe/post?u=a9d74bfce08ba307bfa8b9c78&amp;id=c9114493ef" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
                  <input type="text" name="EMAIL" required class="required email input-email form-control" placeholder="Email address">
                  <input type="submit" value="SUBSCRIBE" name="subscribe" class="button btn btn-dark form-control mt-2">

                  <div id="mce-responses" class="clear">
                    <div class="response" id="mce-error-response" style="display:none"></div>
                    <div class="response" id="mce-success-response" style="display:none"></div>
                  </div> <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
                  <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_a9d74bfce08ba307bfa8b9c78_c9114493ef" tabindex="-1" value=""></div>
                </form>
              </div>
            </div>
          </div>
...
<noscript id="deferred-styles">
  ...
  <?php if (!is_page_template('page-quiz.php')) : ?>
    <?php if (0 && is_single() && 'post' == get_post_type()) :
      if (is_page_template('single-template-featured.php')) : ?>
        <link rel="stylesheet" id="bs-css" href="<?php echo get_template_directory_uri(); ?>/css/dist/featured/bootstrap.min.css" type="text/css" media="all" />
      <?php else : ?>
        <link rel="stylesheet" id="bs-css" href="<?php echo get_template_directory_uri(); ?>/css/dist/single/bootstrap.min.css" type="text/css" media="all" />
      <?php endif;
    elseif (0 && (is_home() || is_front_page())) : ?>
      <link rel="stylesheet" id="bs-css" href="<?php echo get_template_directory_uri(); ?>/css/dist/home/bootstrap.min.css" type="text/css" media="all" />
    <?php else : ?>
      <link rel="stylesheet" id="bs-css" href="<?php echo get_template_directory_uri(); ?>/bs/css/bootstrap.min.css" type="text/css" media="all" />
    <?php endif; ?>
    ...
    <link rel="stylesheet" id="site-css" href="<?php echo get_template_directory_uri(); ?>/css/style.min.css?v=20210412.6" type="text/css" media="all" />

    <?php if (is_home() || is_front_page()) : ?>
      <link rel="stylesheet" id="slick-carousel" href="<?php echo get_template_directory_uri(); ?>/css/slick.css?v=20201204" type="text/css" media="all" />
    <?php endif; // If home page 
    ?>
  <?php endif; ?>
</noscript>
...
<?php if (is_home() || is_front_page()) : ?>
  <style>
    ...
    */
    ...
    .slick-initialized .slick-slide div.observer-wrap {
      /* box-shadow: 0 0.125rem 0.8125rem 0 rgba(0, 0, 0, 0.15); */
      padding: .5rem;
      border: 1px solid #ccc;
    }

    .slick-initialized .slick-slide div.observer-wrap .share-icons {
    ...
    #observer-carousel .slick-slide a h5,
    #observer-carousel .slick-slide a h6 {
      min-height: 3rem;
    }
