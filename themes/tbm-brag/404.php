...
<div class="container bg-yellow rounded-top p-5">
    ...
    <div class="search_wide">
        <div role="search" method="get" id="searchform" class="searchform" action="<?php echo site_url(); ?>">
            ...
            <div class="d-flex flex-column align-items-start">
                ...
                <input type="button" id="searchsubmit" value="Search" class="btn btn-dark mt-1">
            </div>
        </div>
    </div>
    <!--End Search Box-->
