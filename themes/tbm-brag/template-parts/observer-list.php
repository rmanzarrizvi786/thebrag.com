  ...
  ?>
    <div class="d-flex flex-row flex-wrap justify-content-start topics <?php echo is_user_logged_in() ? 'topics-active' : ''; ?>">
      <?php foreach ($lists as $index => $list) : ?>
        <a href="<?php echo esc_url(wp_login_url(home_url('/observer/' . $list->slug . '/'))); ?>" class="d-flex <?php echo in_array($list->id, $my_sub_lists) ? 'subscribed' : ''; ?>" target="_blank" data-list="<?php echo $list->id; ?>">
