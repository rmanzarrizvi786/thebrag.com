...
if (!post_password_required($post)) :
    ...
    if (get_field('author') || get_field('Author')) :
        ...
        if ($author_img_src) :
            ...
            $author_image = '<img src="' . get_template_directory_uri() . '/images/default-avatar.png?v=4" width="64" height="64" class="rounded-circle">';
        ...
        $author_image = get_avatar($post->post_author, 64, get_template_directory_uri() . '/images/default-avatar.png?v=4', $author_name, array('class' => 'rounded-circle'));
