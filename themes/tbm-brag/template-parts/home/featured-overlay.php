            ...
            <div class="read-article-wrap pt-2 w-100">
                <div class="d-flex justify-content-between">
                    ...
                    if (get_field('author', $trending_story_ID) || get_field('Author', $trending_story_ID)) :
                        ...
                        $author_img_src = get_field('author_profile_picture', $rending_story->ID) ? wp_get_attachment_image_src(get_field('author_profile_picture', $trending_story->ID), 'thumbnail') : CDN_URL . 'default-avatar-4.png';
