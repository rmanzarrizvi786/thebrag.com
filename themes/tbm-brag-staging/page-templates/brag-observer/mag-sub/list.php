...
?>
  <div class="row mb-2<?php echo $subscription->is_gift == 'yes' ? ' is-gift' : ''; ?>">
    ...
    <div class="col-md-8 mb-4">
      ...
      <?php endif; ?>
      <div>
        <h3><?php echo $subscription->sub_full_name; ?> <small class="text-muted">ID: <?php echo $subscription->uniqid; ?></small></h3>
        <?php
    ...
    <div class="col-md-4 mb-4 text-right">
      ...
      <div class="btn-group">
        ...
        <?php endif; ?>
        <button type="button" class="btn btn-dark">Remaining Issues: <?php echo isset($subscription->crm_record->Remaining_Issues__c) ? $subscription->crm_record->Remaining_Issues__c : 0; ?></button>
        <button type="button" class="btn btn-dark dropdown-toggle dropdown-toggle-split" id="dropdownMenuReference<?php echo $key; ?>" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-reference="parent">
