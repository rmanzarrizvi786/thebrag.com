...
<head>
  ...
  <style>
    *,
    ...
    #masthead ul li.menu-item-has-children ul li a:after,
    #mobile-menu ul li.menu-item-has-children ul li a:after {
      content: "";
    }

    #masthead ul li.menu-item-has-children ul li,
...
<body <?php body_class(); ?> id="body">
  ...
  <div id="page" class="bg-white" style="display: none;">
    <?php
    $logo_link = home_url('/');
    $logo_url = get_template_directory_uri() . '/images/The-Brag_combo-white.svg';
    $logo_alt = 'The Brag';
        ...
        <div class="container-fluid d-flex justify-content-between" style="position: relative; padding-left: 0; padding-right: 0;">
          ...
          <div id="header-submenu-wrap" class="col-4 col-md-8 text-right align-items-end d-flex flex-column">
            <div class="d-flex align-items-center">
              <nav id="header-submenu" class="navbar navbar-expand-md float-right2 p-0 d-none d-md-block">
              ...
              <div class="d-inline float-right2">
                <?php
                global $current_user;
                wp_get_current_user();
                if (is_user_logged_in()) :  ?>
