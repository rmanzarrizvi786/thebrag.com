...
<body class="<?php echo esc_attr($this->get('body_class')); ?>">
    ...
    <article class="amp-wp-article" style="margin-top: 50px">

        <div style="text-align: center; margin-top: 10px;">
            <amp-ad width=320 height=50 type="doubleclick" data-slot="/9876188/brag/brag_hrec_1" json='{"targeting":{"pagepath":"<?php echo $pagepath; ?>"}}'>
            </amp-ad>
        </div>
        ...
        <div class="amp-wp-article-content">
            ...
            ?>
                        <div style="text-align: center">
                            <amp-ad width=300 height=250 type="doubleclick" data-slot="/9876188/brag/brag_vrec_1" json='{"targeting":{"pagepath":"<?php echo $pagepath; ?>"}}'>
                            </amp-ad>
                        </div>
            <?php
                    endif; // Para 2
        ...
        <div style="text-align: center">
            <amp-ad width=300 height=250 type="doubleclick" data-slot="/9876188/brag/brag_vrec_2" json='{"targeting":{"pagepath":"<?php echo $pagepath; ?>"}}'>
            </amp-ad>
        </div>
