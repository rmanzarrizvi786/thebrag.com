...
function load_js_css()
{
    ...
    // if ( is_page_template( 'page-submit-gig.php' ) ) {
    // wp_enqueue_script( 'submit-gig', get_template_directory_uri() . '/js/gig.js', array ( 'jquery' ), '20200316', true);
    // }

    if (is_home() || is_front_page()) {
        wp_enqueue_script('slick-carousel', get_template_directory_uri() . '/js/slick.min.js', array('jquery'), '20201204', true);
    }
...
function td_theme_add_init()
{
    ...
    wp_enqueue_style('admin', $file_dir . '/css/admin.css', false, '1.1', 'all');
...
function ssm_amp_additional_css_styles($amp_template)
{
    ...
    .amp-wp-article { padding: 0 0 20px 0; }
...
function render_ad_tag($tag, $page = '', $slot_no = 1)
{
    if ('teads' == $tag) {
        return "<div id='teads-outstream' style='margin: auto; height: 0;'>
    <script>
      googletag.cmd.push(function() { googletag.display('teads-outstream'); });
    </script>
    </div>";
    }
    return render_dfp_ad_tag($tag, $page, $slot_no);
    /*
  if ( get_option( 'serve_direct_ads' ) == 1 ) :
    return render_dfp_ad_tag( $tag, $page, $slot_no );
  else :
    return render_proper_ad_tag( $tag, $page, $slot_no );
  endif;
  */
}

function render_dfp_ad_tag($tag, $page = '', $slot_no = 1)
{
    // echo '<h1>' . $slot_no . '</h1>';
    switch ($tag):
        case 'header_mobile': ?>
            <div id='brag_header_mobile' style='width: 320px; height: 50px; margin: auto;' class=" ad-sticky">
                <script>
                    googletag.cmd.push(function() {
                        googletag.display('brag_header_mobile');
                    });
                </script>
            </div>
        <?php
            break;
        case 'leaderboard': ?>
            <div id='adm_leaderboard'>
                <script>
                    googletag.cmd.push(function() {
                        googletag.display('adm_leaderboard');
                    });
                </script>
            </div>
            <?php
        ...
        case 'side_1':
            if (1 == $slot_no) :
            ?>
                <!-- /9876188/brag/brag_side_1 -->
                <div id='brag_side_1' style='width: 300px; margin: auto;'>
                    <script>
                        googletag.cmd.push(function() {
                            googletag.display('brag_side_1');
                        });
                    </script>
                </div>
            <?php else : // $slot_no > 1 
            ?>
                <div id='brag_side_1_<?php echo $slot_no; ?>' style='width: 300px; margin: auto;'>
                    <script>
                        googletag.cmd.push(function() {
                            ...
                            addSize([0, 0], []).
                            build();
                            var adslot_tbm_side_1_<?php echo $slot_no; ?> = googletag.defineSlot('/9876188/brag/brag_side_1', [300, 250], 'brag_side_1_<?php echo $slot_no; ?>')
                                .addService(googletag.pubads())
                                .setTargeting('count', '<?php echo $slot_no; ?>')
                                .setTargeting('pos', 'rail1');
                            adslot_tbm_side_1_<?php echo $slot_no; ?>.defineSizeMapping(mapping_rail);
                            googletag.pubads().refresh([adslot_tbm_side_1_<?php echo $slot_no; ?>]);
                        });
                    </script>
                </div>
            <?php endif; // $slot_no check
            break;
        ...
        case 'rail1':
            if (1 == $slot_no) :
            ?>
                <div id='adm_rail1' class="my-2 my-md-0" style='width: 300px; margin: auto;'>
                    <script>
                        googletag.cmd.push(function() {
            ...
            <?php else : // $slot_no > 1 
            ?>
                <div id='adm_rail1_<?php echo $slot_no; ?>' style='width: 300px; margin: auto;'>
                    <script>
                        googletag.cmd.push(function() {
                            var mapping_rail = googletag.sizeMapping().
                            addSize([970, 250], [
                            ...
                            addSize([0, 0], []).
                            build();
                            var adslot_rail1_<?php echo $slot_no; ?> = googletag.defineSlot('/9876188/brag/homepage_rail1', [
                                    [300, 250],
                                    [300, 251]
                                ], 'adm_rail1_<?php echo $slot_no; ?>')
                                .addService(googletag.pubads())
                                .setTargeting('count', '<?php echo $slot_no; ?>')
                                .setTargeting('pos', 'rail1');
                            adslot_rail1_<?php echo $slot_no; ?>.defineSizeMapping(mapping_rail);
                            googletag.pubads().refresh([adslot_rail1_<?php echo $slot_no; ?>]);
                        });
                    </script>
                </div>
            <?php endif; // $slot_no check
        ...
        case 'inbody1':
            if (1 == $slot_no) :
            ?>
                <div id='adm_inbody1' style='width: auto; margin: auto;'>
                    <script>
                        googletag.cmd.push(function() {
            ...
            <?php else : // $slot_no > 1 
            ?>
                <div id='adm_inbody1_<?php echo $slot_no; ?>' style='width: auto; margin: auto;'>
                    <script>
                        googletag.cmd.push(function() {
                            var adslot_inbody1<?php echo $slot_no; ?> = googletag.defineSlot('/9876188/brag/culture_article_inbodyX', [
                                    [300, 250],
                                    [300, 251]
                                ], 'adm_inbody1_<?php echo $slot_no; ?>')
                                .addService(googletag.pubads())
                                .setTargeting('count', '<?php echo $slot_no; ?>')
                                .setTargeting('pos', 'inbodyX');
        ...
        case 'content_2':
            ?>
            <div id='adm_inbody2<?php echo $slot_no; ?>' style='width: auto; margin: auto;' class="adm_inbody">
                <script>
                    googletag.cmd.push(function() {
                        var adslot_inbody2<?php echo $slot_no; ?> = googletag.defineSlot('/9876188/brag/culture_article_inbodyX', [
                                [300, 250],
                                [300, 251]
                            ], 'adm_inbody2<?php echo $slot_no; ?>')
                            .addService(googletag.pubads())
                            .setTargeting('count', '2<?php echo $slot_no; ?>')
                            .setTargeting('pos', 'inbodyX');
                        googletag.pubads().refresh([adslot_inbody2<?php echo $slot_no; ?>]);
                    });
                </script>
            </div>
        <?php
        ...
        case 'content_3':
        ?>
            <div id='adm_inbody3<?php echo $slot_no; ?>' style='width: auto; margin: auto;' class="adm_inbody">
                <script>
                    googletag.cmd.push(function() {
                        var adslot_inbody3<?php echo $slot_no; ?> = googletag.defineSlot('/9876188/brag/culture_article_inbodyX', [
                                [300, 250],
                                [300, 251]
                            ], 'adm_inbody3<?php echo $slot_no; ?>')
                            .addService(googletag.pubads())
                            .setTargeting('count', '3<?php echo $slot_no; ?>')
                            .setTargeting('pos', 'inbodyX');
                        googletag.pubads().refresh([adslot_inbody3<?php echo $slot_no; ?>]);
                    });
                </script>
            </div>
        <?php
        ...
        case 'content_4':
        ?>
            <div id='adm_inbody4<?php echo $slot_no; ?>' style='width: auto; margin: auto;' class="adm_inbody">
                <script>
                    googletag.cmd.push(function() {
                        var adslot_inbody4<?php echo $slot_no; ?> = googletag.defineSlot('/9876188/brag/culture_article_inbodyX', [
                                [300, 250],
                                [300, 251]
                            ], 'adm_inbody4<?php echo $slot_no; ?>')
                            .addService(googletag.pubads())
                            .setTargeting('count', '4<?php echo $slot_no; ?>')
                            .setTargeting('pos', 'inbodyX');
                        googletag.pubads().refresh([adslot_inbody4<?php echo $slot_no; ?>]);
                    });
                </script>
            </div>
        <?php
        ...
        case 'content_5':
        ?>
            <div id='adm_inbody5<?php echo $slot_no; ?>' style='width: auto; margin: auto;' class="adm_inbody">
                <script>
                    googletag.cmd.push(function() {
                        var adslot_inbody5<?php echo $slot_no; ?> = googletag.defineSlot('/9876188/brag/culture_article_inbodyX', [
                                [300, 250],
                                [300, 251]
                            ], 'adm_inbody5<?php echo $slot_no; ?>')
                            .addService(googletag.pubads())
                            .setTargeting('count', '5<?php echo $slot_no; ?>')
                            .setTargeting('pos', 'inbodyX');
                        googletag.pubads().refresh([adslot_inbody5<?php echo $slot_no; ?>]);
                    });
                </script>
            </div>
        <?php
        ...
        case 'content_6':
        ?>
            <div id='adm_inbody6<?php echo $slot_no; ?>' style='width: auto; margin: auto;' class="adm_inbody">
                <script>
                    googletag.cmd.push(function() {
                        var adslot_inbody6<?php echo $slot_no; ?> = googletag.defineSlot('/9876188/brag/culture_article_inbodyX', [
                                [300, 250],
                                [300, 251]
                            ], 'adm_inbody6<?php echo $slot_no; ?>')
                            .addService(googletag.pubads())
                            .setTargeting('count', '6<?php echo $slot_no; ?>')
                            .setTargeting('pos', 'inbodyX');
                        googletag.pubads().refresh([adslot_inbody6<?php echo $slot_no; ?>]);
                    });
                </script>
            </div>
            <?php
        ...
        case 'rail2':
            if (1 == $slot_no) :
            ?>
                <div id='adm_rail2' style='width: 300px; margin: auto;'>
                    <script>
                        googletag.cmd.push(function() {
            ...
            <?php else : // $slot_no > 1 
            ?>
                <div id='adm_rail2<?php echo $slot_no; ?>' style='width: 300px; margin: auto;'>
                    <script>
                        googletag.cmd.push(function() {
                            var mapping_rail = googletag.sizeMapping().
                            addSize([970, 250], [
                            ...
                            addSize([0, 0], []).
                            build();
                            var adslot_rail2<?php echo $slot_no; ?> = googletag.defineSlot('/9876188/brag/homepage_rail2', [
                                    [300, 600]
                                ], 'adm_rail2<?php echo $slot_no; ?>')
                                .addService(googletag.pubads())
                                .setTargeting('pos', 'rail2');
                            adslot_rail2<?php echo $slot_no; ?>.defineSizeMapping(mapping_rail);
                            googletag.pubads().refresh([adslot_rail2<?php echo $slot_no; ?>]);
                        });
                    </script>
                </div>
            <?php endif; // $slot_no check
        ...
        case 'railX':
            if (1 == $slot_no) :
            ?>
                <div id='adm_railX' style='width: 300px; margin: auto;'>
                    <script>
                        googletag.cmd.push(function() {
                            googletag.display('adm_railX');
                        });
                    </script>
                </div>
            <?php else : // $slot_no > 1 
            ?>
                <div id='adm_railX<?php echo $slot_no; ?>' style='width: 300px; margin: auto;'>
                    <script>
                        googletag.cmd.push(function() {
                            var adslot_railX<?php echo $slot_no; ?> = googletag.defineSlot('/9876188/brag/homepage_railX', [
                                    [300, 250],
                                    [300, 251]
                                ], 'adm_railX<?php echo $slot_no; ?>')
                                .addService(googletag.pubads())
                                .setTargeting('pos', 'railX');
                            googletag.pubads().refresh([adslot_railX<?php echo $slot_no; ?>]);
                        });
                    </script>
                </div>
            <?php endif; // $slot_no check
            //   return render_proper_ad_tag( 'side_' . $slot_no, $page, $slot_no );
            break;
...
function render_proper_ad_tag($tag, $page = '', $slot_no = 1)
{
    return;
    switch ($tag):
        case 'header_mobile': ?>
            <div class="proper-ad-unit">
                <div id="proper-ad-thebrag_sticky_1">
                    <script>
                        propertag.cmd.push(function() {
                            proper_display('thebrag_sticky_1');
                        });
                    </script>
                </div>
            </div>
        ...
        case 'hrec_1': ?>
            <div class="proper-ad-unit">
                <div id="proper-ad-thebrag_main_1">
                    <script>
                        propertag.cmd.push(function() {
                            proper_display('thebrag_main_1');
                        });
                    </script>
                </div>
            </div>
<?php break;
        ...
        case 'side_1':
        case 'mrec_1':
            $slot_id = 'thebrag_side_1';
            if ($slot_no > 1) :
                $slot_id .= '-' . $slot_no;
            endif;
            echo '<div class="proper-ad-unit"><div id="proper-ad-' . $slot_id . '"><script>propertag.cmd.push(function()
      { proper_display(\'' . $slot_id . '\'); }); </script> </div></div>';
            break;
        case 'side_2':
        case 'mrec_2':
            $slot_id = 'thebrag_side_2';
            if ($slot_no > 1) :
                $slot_id .= '-' . $slot_no;
            endif;
            echo '<div class="proper-ad-unit"><div id="proper-ad-' . $slot_id . '"><script>propertag.cmd.push(function()
      ...
      { proper_display(\'' . $slot_id . '\'); }); </script> </div></div>';
            break;
        case 'skin':
            echo '<div class="proper-ad-unit">
    <div id="proper-ad-thebrag_skin"> <script> propertag.cmd.push(function() { proper_display(\'thebrag_skin\'); }); </script> </div>
</div>';
            break;
        case 'incontent':
            break;
