  ...
  <div class="row py-4 my-4" style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd;">
    <div class="col-12">
      <ul class="nav nav-pills justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link<?php echo $city == $the_city ? ' active btn-dark' : ''; ?>" href="/gigs/<?php echo $the_city; ?>/"><?php echo strtoupper( $the_city ); ?></a>
        </li>
        <?php endforeach; ?>
        <li class="nav-item d-none d-md-block ml-2">
          <a href="/submit-gig" class="btn-primary btn-sm nav-link">SUBMIT A GIG</a>
        </li>
      </ul>
    </div>
  </div>
